...
Идентичность, физические данные, медицинский контекст и правила адаптации.
Цели и периодизация — в `goals.md`. Программа зала — в `gym-program.md`. Протокол веса — в `weight-protocol.md`.
...
- Creatine 10 g/day (water retention +1–1.5 kg — account for in weight)
- PRP injections knee — 1 course per 12–18 months
- Ferritin protocol (update when known)
- Semaglutide microdose — see `weight-protocol.md`

## Weekly Training Structure (baseline)
| Day | Session |
|-----|---------|
| Mon | Gym A — heavy legs + upper base |
| Tue | Easy run 8–10 km (Z2) |
| Wed | Gym B — heavy upper + light legs/stabilisation |
| Thu | Intervals 8–12 km |
| Fri | Pool 2 km (optional) + pull-ups at work |
| Sat | Parkrun 5 km |
| Sun | Long run 15–18 km |

Pull-ups at work: Tue/Thu/Fri 3×12.
Недельная структура — baseline; фактический план недели — в `weeks/YYYY-WW.md`.

## Hard Limits (никогда)
- NO leg extension (gonarthrosis grade 3)
- NO forward lunges (patellofemoral stress)
- NO deep squat with strong forward lean
- Remove gym completely 10 days before race
- Incline press — не до полной амплитуды при возврате симптомов плеча

## Adaptation Rules (ежедневно)
- HRV < 40 ms → replace quality with easy
- Sleep < 6 h → remove intensity, keep easy volume
- ATL/CTL > 1.3 → add rest day
- RHR > 54 bpm несколько дней подряд → easy day
